  ...
  <div class="main-container">
    ...
    <div class="wrapper">
      <div class="form-box register">
        ...
        <form action="adminRegister_check.php" method="post">
          <div class="input-box">
            <span class="icon"><ion-icon name="person-circle-outline"></ion-icon></span>
            <input type="text" name="txtAdminID" required aria-label="Admin ID">
          ...
          <button id="adminRegisterbtn" type="submit" class="btn">Register</button>
          <div class="login-register">
            <p>Already have an account? <a href="adminLogin.php" class="login-link">Login Now</a></p>
          </div>
        </form>
      </div>
    </div>
