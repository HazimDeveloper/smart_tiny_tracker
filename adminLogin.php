  ...
  <div class="main-container">
    ...
    <div class="wrapper">
      <div class="form-box login">
        <h2>LOGIN</h2>
        <form name="login" method="post" action="adminLogin_check.php">
          <div class="input-box">
            <span class="icon"><ion-icon name="person-circle-outline"></ion-icon></span>
            <input type="text" name="admin" id="admin" required aria-label="Admin ID" value="<?php if(isset($_COOKIE["admin"])) { echo $_COOKIE["admin"]; } ?>">
